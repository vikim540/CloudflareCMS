...
CREATE TABLE IF NOT EXISTS ay_single (
  ...
  banner_mb TEXT DEFAULT '', banner_alt TEXT DEFAULT '', banner_title TEXT DEFAULT '', whatsapp_phone TEXT DEFAULT '', whatsapp_text TEXT DEFAULT '', whatsapp_btn TEXT DEFAULT '立即預約查詢', packages TEXT DEFAULT '', terms TEXT DEFAULT '',
